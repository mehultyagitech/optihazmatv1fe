...
const rows = [
    { id: 1, equipmentName: 'IT Rack UPS 1 (Next Gen and NET SWAN)', disabled: false },
    { id: 2, equipmentName: 'IT Rack UPS 2 (Next Gen and NET SWAN)', disabled: true },
    { id: 3, equipmentName: 'Battery- Auxiliary Engine 1', disabled: false },
];
